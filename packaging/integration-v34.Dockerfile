# Incremental integration image.  It keeps the v29 runtime and layers only
# the Yinyun API and the files changed by this release; music data and
# Songloft/Navidrome containers are never copied or rebuilt.
